...
public interface IProductVariantValueRepository
{
    ...
    Task<bool> ExistsAsync(Expression<Func<ProductVariantValue, bool>> predicate, CancellationToken ct = default);
    Task<int> ExecuteDeleteAsync(Expression<Func<ProductVariantValue, bool>> predicate, CancellationToken ct = default);
    Task<int> ExecuteUpdateAsync(Expression<Func<ProductVariantValue, bool>> predicate, Action<UpdateSettersBuilder> action, CancellationToken ct = default);
