...
public interface IProductDomainService
{
    ...
    Task<Result> ArchiveAsync(Guid productId, CancellationToken ct = default);
    ...
    Task<Result> DeleteProductVariantAsync(Guid productId, Guid variantId, CancellationToken ct = default);
