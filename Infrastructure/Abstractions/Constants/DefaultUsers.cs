...
public class DefaultUsers
{
    ...
    public const string Email = "admin@PPRS.net";
    public const string UserName = "admin";
    public const string Password = "P@ssword123";
    public const string FirstName = "PPRS";
    public const string LastName = "Admin";
    public const string Region = "Platform";
    public const string VisitorType = "Adminstrator";
}
