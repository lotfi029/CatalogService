...
START TRANSACTION;
ALTER TABLE variant_attribute_definitions DROP COLUMN is_required;

ALTER TABLE variant_attribute_definitions DROP COLUMN validation_rules;

ALTER TABLE variant_attribute_definitions ALTER COLUMN allowed_values DROP NOT NULL;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251129164608_UpdateVariantAttributeDefinitionSchema', '10.0.0');
...
ALTER TABLE variant_attribute_definitions ALTER COLUMN data_type TYPE smallint;

ALTER TABLE variant_attribute_definitions ADD data_type_name character varying(10) NOT NULL DEFAULT '';

CREATE INDEX idx_products_status ON products (status);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251130210924_UpdateDatatypeColumn', '10.0.0');

COMMIT;

START TRANSACTION;
ALTER TABLE variant_attribute_definitions DROP COLUMN affects_pricing;

ALTER TABLE variant_attribute_definitions DROP COLUMN display_order;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251202205850_UpdateVariantAttributeDefinition', '10.0.0');

COMMIT;

START TRANSACTION;
DROP INDEX idx_attributes_is_filterable;

DROP INDEX idx_attributes_is_searchable;

DROP INDEX idx_attributes_type;

ALTER TABLE attributes DROP CONSTRAINT chk_attributes_type;

ALTER TABLE attributes RENAME COLUMN type TO options_type;

ALTER TABLE attributes ADD options_type_name character varying(10) NOT NULL DEFAULT '';

CREATE INDEX idx_attributes_is_filterable ON attributes (is_filterable);

CREATE INDEX idx_attributes_is_searchable ON attributes (is_searchable);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251204205432_UpdateAttributeEntity', '10.0.0');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251205130631_UpdateProductTable', '10.0.0');
...
ALTER TABLE products ALTER COLUMN vendor_id TYPE uuid;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251205200424_ChangeVendorIdType', '10.0.0');

COMMIT;

START TRANSACTION;
DROP INDEX idx_product_variants_is_active;

ALTER TABLE product_variants DROP COLUMN created_at;

ALTER TABLE product_variants DROP COLUMN created_by;

ALTER TABLE product_variants DROP COLUMN deleted_at;

ALTER TABLE product_variants DROP COLUMN deleted_by;

ALTER TABLE product_variants DROP COLUMN is_active;

ALTER TABLE product_variants DROP COLUMN is_deleted;

ALTER TABLE product_variants DROP COLUMN last_updated_at;

ALTER TABLE product_variants DROP COLUMN last_updated_by;

ALTER TABLE product_categories DROP COLUMN created_by;

ALTER TABLE product_variants ALTER COLUMN customization_options DROP NOT NULL;

ALTER TABLE product_variants ALTER COLUMN compare_at_price DROP NOT NULL;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20251208130812_UpdateProductVariantEntity', '10.0.0');
