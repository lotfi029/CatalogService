...
//    {
//        var category = Category.Create("Electronics", "electronics", 0, true).Value!;
//        AppDbContext.Categories.Add(category);
//        await AppDbContext.SaveChangesAsync();
...
//    {
//        var parent = Category.Create("Electronics", "electronics", 0, true).Value!;
//        var child = Category.Create("Laptops", "laptops", 1, true, parent.Id, parentPath: parent.Path).Value!;
