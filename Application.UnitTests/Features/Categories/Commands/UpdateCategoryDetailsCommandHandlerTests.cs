...
public class UpdateCategoryDetailsCommandHandlerTests
{
    ...
    public async Task HandleAsync_WithValidCommand_Should_ReturnSuccess()
    {
        ...
        _mockRepository
            .Setup(x => x.FindByIdAsync(_testCategory.Id, It.IsAny<CancellationToken>()))
        ...
        _mockRepository.Verify(
            x => x.FindByIdAsync(_testCategory.Id, It.IsAny<CancellationToken>()),
            Times.Once);
    ...
    public async Task HandleAsync_WithNonExistentCategory_Should_ReturnNotFound()
    {
        ...
        _mockRepository
            .Setup(x => x.FindByIdAsync(categoryId, It.IsAny<CancellationToken>()))
    ...
    public async Task HandleAsync_WithCancellationToken_Should_PassThroughAllLayers()
    {
        ...
        _mockRepository
            .Setup(x => x.FindByIdAsync(_testCategory.Id, ct))
            .ReturnsAsync(_testCategory);
        ...
        _mockRepository.Verify(
            x => x.FindByIdAsync(_testCategory.Id, ct),
            Times.Once);
