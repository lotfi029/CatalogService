...
//        _mockRepository
//            .Setup(x => x.FindAsync(_sourceCategory.Id, null, It.IsAny<CancellationToken>()))
//            .ReturnsAsync(_sourceCategory);

//        _mockRepository
//            .Setup(x => x.FindAsync(_targetParent.Id, null, It.IsAny<CancellationToken>()))
...
//        _mockRepository
//            .Setup(x => x.FindAsync(command.Id, null, It.IsAny<CancellationToken>()))
...
//        _mockRepository.Verify(
//            x => x.FindAsync(_targetParent.Id, null, It.IsAny<CancellationToken>()),
//            Times.Never);
//    }
...
//        _mockRepository
//            .Setup(x => x.FindAsync(command.NewParentId, null, It.IsAny<CancellationToken>()))
//            .ReturnsAsync((Category?)null);
...
//        _mockRepository
//            .Setup(x => x.FindAsync(category.Id, null, It.IsAny<CancellationToken>()))
...
//        _mockRepository.Verify(
//            x => x.FindAsync(parentId, null, It.IsAny<CancellationToken>()),
//            Times.Never);
//    }
//    [Fact]
...
//        _mockRepository
//            .Setup(x => x.FindAsync(_sourceCategory.Id, null, ct))
//            .ReturnsAsync(_sourceCategory);

//        _mockRepository
//            .Setup(x => x.FindAsync(_targetParent.Id,null, ct))
//            .ReturnsAsync(_targetParent);
